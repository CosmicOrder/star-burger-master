...
Это сайт [сети](https://starburger.gq) ресторанов Star Burger. Здесь можно заказать превосходные бургеры с доставкой на дом.
...
Для того чтобы быстро обновить код на сервере, перейдите в корневую папку проекта 
